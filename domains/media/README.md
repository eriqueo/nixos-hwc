...
## Changelog
- 2026-08-17: Law 12 freshness pass on `immich-container/README.md` — no module changes.
  That file still headed itself `domains/server/containers/immich/` and listed an
  `options.nix`; corrected to its real path, with `parts/config.nix` and inline options
  (Law 10). Its 2026-03-29 external-photo-library mount (`0a0f7414`) was also unlogged.
