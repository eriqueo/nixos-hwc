...
## Changelog
- 2026-08-06: youtube/transcripts — the transcript UI takes **multiple URL boxes**,
  accepts playlists, and offers a save-location picker (ffaa9cb6). The service was
  renamed `yt-transcripts-api` → `transcripts` everywhere in the same-day
  refactor, including the module directory
  `youtube/parts/yt-transcripts-api/` → `youtube/parts/transcripts/` (01700465).
