...
## Changelog
- 2026-07-27: Law 12 changelog backfill — the `immich-container/` README was refreshed to catch up its changelog + Structure block with already-committed changes (photo-mount swap, `index.nix`/`parts/` layout). Docs only; no functional change.
