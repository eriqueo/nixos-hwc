...
- 2026-08-17: Structure block corrected — it still listed `parts/scripts.nix`, deleted
  in 2026-05-21 (`5da97868`). `index.nix` is now the module's only file.
- 2026-05-21: `5da97868` — deleted `parts/scripts.nix` (-58). The CLI-tool table above
  still holds; those wrappers are defined in `index.nix`.
