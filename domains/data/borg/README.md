...
- 2026-05-21: Deleted `parts/scripts.nix` (5da97868). It held pure helper
  functions that nothing imported — its own header still named the pre-migration
  path `domains/system/services/borg/`. `index.nix` is now the only file here.
