...
- 2026-05-21: Deleted `parts/scripts.nix` (5da97868) — a helper-function file
  (`mkBorgWrapper`, `mkListBackupsScript`, `mkRestoreScript`) that nothing
  imported; the CLI tools below are built in `index.nix`. `## Structure`
  updated to match.
