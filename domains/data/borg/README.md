...
- 2026-07-27: Removed `parts/scripts.nix` (unused Borg wrapper-script helpers: `mkBorgWrapper`, `mkListBackupsScript`, `mkRestoreScript`) — deleted in commit `5da97868`. Structure block updated; `parts/` no longer exists.
