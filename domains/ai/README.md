...
- 2026-08-31: Law 12 sweep — `agent/`, `mcp/`, `personas/` and `profiles/`
  READMEs brought current with their code (`9366f8bc`). Documentation only; no
  Nix or code change in this domain.
