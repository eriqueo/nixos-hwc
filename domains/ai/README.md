...
- 2026-08-03: Law 12 sweep of this domain's sub-READMEs — `agent/`, `mcp/`,
  `personas/`, `profiles/` backfilled with diff-derived changelog entries and
  corrected Structure blocks (`mcp/heartwood/` had already moved to
  `domains/business/mcp/`; `options.nix` files are gone under Law 10). Docs
  only; no module changed.
