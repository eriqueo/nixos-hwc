...
- 2026-06-16: Law-12 changelog refresh propagated through every `domains/ai/*`
  subdir README (agent, cloud, local-workflows, mcp, ollama, personas,
  profiles, tools) — see each sub-README for specifics. No code change at this
  level.
