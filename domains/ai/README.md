...
- 2026-06-12: README-only Law 12 refresh — backfilled changelogs in `agent/`, `cloud/`, `local-workflows/`, `mcp/`, `ollama/`, `personas/`, `profiles/`, `tools/` for drift accrued since the 2025-12/2026-02-28 baseline (sprints 2/4/5, ai refactors, dead-tree purges, namespace consolidation). No code change.
