...
- 2026-06-29: Bumped freshness watermark — the only change since the previous entry is the Law-12 README sweep across the AI subdomains (c5962167). See `agent/`, `cloud/`, `mcp/`, `personas/`, `profiles/`, `tools/` for the underlying code commits.
