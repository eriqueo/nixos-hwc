...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    # Ensure pipewire services start automatically with graphical session
    systemd.user.services.pipewire.wantedBy = lib.mkIf cfg.audio.enable [ "graphical-session.target" ];
    systemd.user.services.pipewire-pulse.wantedBy = lib.mkIf cfg.audio.enable [ "graphical-session.target" ];
    systemd.user.services.wireplumber.wantedBy = lib.mkIf cfg.audio.enable [ "graphical-session.target" ];
