...
## Changelog
- 2026-06-11: `mcp/` — added `hwc_tasks_*` (`bd9a1cfc`): task CRUD over Radicale CalDAV for claude.ai, matching the Phase C tasks plumbing (`domains/mail/tasks/`). Also kept hwc-phone Termius SSH key in the declarative `authorized_keys` set (`96bde13d`).
