...
- 2026-06-22: `guiLibs` flag in system core replaces desktop/gaming list duplication (nixld refactor); Law 9/10 — convert option-declaring leaf modules to directory modules; hwc-server tailnet rename; `packages` — add `sqlite` CLI to base bundle.
