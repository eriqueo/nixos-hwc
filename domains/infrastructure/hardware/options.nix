    ...
    gpu = {
      ...
      intel = {
        ...
        enableCompute = lib.mkOption {
          type = t.bool;
          default = false;
          description = "Enable Intel GPU compute support (oneAPI, Level Zero) for AI/ML workloads.";
        };

        enableMonitoring = lib.mkOption {
          type = t.bool;
          default = false;
          description = "Enable Intel GPU monitoring tools (intel_gpu_top, intel-gpu-tools).";
        };
      };
