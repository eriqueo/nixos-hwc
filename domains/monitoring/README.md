...
- 2026-06-09: Homepage migrated to name-based vhosts (`ee9f1f17`, `8fdee440`, `ed10482b`). Grafana/Vaultwarden/Firefly/CloudBeaver/Jellyfin/Jellyseerr/Pinchflat/Frigate/Immich + 25 port-mode services now `<name>.hwc.iheartwoodcraft.com` on :443 (shared wildcard cert). Added "Apps & Tools" group (Uptime Kuma, Lead Scout, Hermes, SR Analyzer, Heartwood CMS, Calibre) + tiles for Estimator, Bathroom Calculator, Morning Briefing, Market Trials, Market Intelligence, YT Transcripts. Closes 4 static ports; n8n + subpath services unchanged.
