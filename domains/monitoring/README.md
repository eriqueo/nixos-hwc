...
## Changelog
- 2026-08-06: homepage — the YT Transcripts tile follows the service rename,
  `yt-transcripts-api.hwc.iheartwoodcraft.com` → `transcripts.hwc.iheartwoodcraft.com`
  (01700465). Link only; no dashboard or probe change.
