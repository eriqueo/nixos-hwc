...
- 2026-06-29: No code change since the 2026-06-12 entry below — `notify/README.md` was the only update (0bb92c7a, the nightly-builds Discord wiring changelog landing). Pulling the freshness watermark forward.
