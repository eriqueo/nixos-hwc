...
## Changelog
- 2026-07-27: Law 12 changelog backfill — the `notify/` subdomain README was refreshed to catch up its changelog with already-committed changes (finance-to-alerts route, #media/#frigate re-homing, alert-actionability pass, Slack eradication). Docs only; no functional change.
