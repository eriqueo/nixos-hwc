...
## Changelog
- 2026-07-06: Law 12 child-README sweep — refreshed the `notify/` module README to match current code (gluetun + mail-health criticals rewired to hwc-notify, dispatcher hardening). No notifications-index code change.
