...
- 2026-06-12: Propagated the nightly-builds wiring note to `notify/README.md` (`0bb92c7a`) — no code change, just bringing the sub-README in line so the freshness linter no longer marks this tree stale.
