...
## Changelog
- 2026-07-29: Comment-only — principle citations in `notify/parts/src/src/`
  (`config.ts`, `core/errors.ts`, `schemas/notification.ts`) repointed from the
  retired `creating-systems.md` split-doc sections to rev 3 numbers in the
  single canonical engineering-principles doc (16 Late Binding, 19 Errors as
  Values, 2 Parse Don't Validate). No behavior change.
