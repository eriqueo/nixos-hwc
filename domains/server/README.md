...
## Changelog
- 2026-08-03: Law 12 sweep under `native/ai/` — `persona-daemon/README.md`
  logged the 2026-06-09 Law 10 inlining of its `options.nix`, and
  `hermes/parts/bootstrap/README.md` gained a Changelog covering the
  strip-types-compat rewrite of `HermesDeployError`. Docs only.
