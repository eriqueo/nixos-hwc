...
## Changelog
- 2026-09-14: Law-12 refresh under `native/ai/`. `persona-daemon/README.md` recorded
  the 2026-06-09 Law 10 inlining of its 145-line `options.nix`, and
  `hermes/parts/bootstrap/README.md` gained a Changelog for the 2026-05-29
  strip-types fix to `HermesDeployError`. Docs only.
