...
## Changelog
- 2026-08-10: Law 12 refresh under `native/ai/` — `persona-daemon` (2026-06-09
  Law 10 options inlining) and `hermes/parts/bootstrap` (2026-05-29
  strip-types-compatible `HermesDeployError`; the file had no changelog section).
  Docs only.
