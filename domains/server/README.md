...
- 2026-08-31: Law 12 sweep — `native/ai/persona-daemon/` and
  `native/ai/hermes/parts/bootstrap/` READMEs brought current with their code
  (`bd1a6d72`). Documentation only; no Nix or TypeScript change.
