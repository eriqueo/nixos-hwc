...
- 2026-06-22: Merge origin/main into feat/workbench-zellij; mail/calendar Radicale (VEVENT) backend + retire plain khal; server/brain-mcp flock-serialize git + drop `clean -fd` footgun.
- 2026-06-22: README sweep across server/native/ai children (hermes/parts/bootstrap, market-intelligence, persona-daemon) — Law 12 catch-up after Law 10 inline-options sweep.
