...
- 2026-06-09: Law 10 — `options.nix` deleted and its 145 lines of option
  declarations inlined into `index.nix` (part of the repo-wide sweep that
  inlined the last 18 `options.nix` files). Structure/behavior otherwise
  unchanged.
