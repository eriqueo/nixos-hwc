...
- 2026-06-29: Law 10 stragglers swept (056cf4d7) — module's `options.nix` inlined into `index.nix` under `# OPTIONS`. Pure relocation; server toplevel drv hash unchanged.
