...
- 2026-06-09: Law 10 migration — the module's `options.nix` (145 lines) was
  inlined into `index.nix` under an `# OPTIONS` banner; options are declared in
  `index.nix`, never a separate file (703ea3a2). Pure relocation.
