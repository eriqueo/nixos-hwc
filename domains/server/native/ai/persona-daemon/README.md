...
- 2026-06-09: Law 10 migration — `options.nix` inlined into `index.nix` (pure relocation, no semantic change; part of the fleet-wide inlining of the 18 remaining stragglers, `703ea3a2`).
