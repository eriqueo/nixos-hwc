...
- 2026-06-09: Charter Law 10 completion — inline the remaining `options.nix` files into their `index.nix` under a `# OPTIONS` banner (056cf4d7). Pure relocation; behavior unchanged.
