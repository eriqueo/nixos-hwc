...
- **2026-06-15** — Sub-README backfill — `parts/bootstrap/README.md` updated to record the Node 22 strip-types parameter-property fix (59dca996). No code change in the `hermes/` aggregator.
