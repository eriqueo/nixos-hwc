...
## Changelog
- 2026-08-03: `vaultwarden/README.md` backfilled with the 2026-07-06 image pin
  (`vaultwarden/server:latest` → `1.35.4`, Law 15 critical tier) and the
  follow-up that moved the pin comment off the `mkOption` line where it had
  swallowed the closing brace. Docs only.
