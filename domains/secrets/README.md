...
## Changelog
- 2026-07-27: Law 12 changelog backfill — the `vaultwarden/` subdomain README was refreshed to catch up its changelog with the already-committed image pin (`latest` → `1.35.4`, critical tier). Docs only; no functional change.
