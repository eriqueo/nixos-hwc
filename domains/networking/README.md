...
## Changelog
- 2026-06-29: Bumped freshness watermark — only change since the previous entry is the Law-12 README sweep on `networking/pihole/` (22ab6af7). No code change at the domain level.
