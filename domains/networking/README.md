...
## Changelog
- 2026-07-20: Added `research-scout` vhost route (`routes.nix`) → `research-scout.hwc.iheartwoodcraft.com` for the third scout app (research intelligence, :8422). Tailnet-only name-based vhost on the existing wildcard cert; mirrors the home-scout shape.
