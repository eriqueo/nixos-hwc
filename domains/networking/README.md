...
## Changelog
- 2026-06-16: `6310fdc5` — read-only Kanban board for the refinery gauntlet
  hopper landed in `automation/refinery`; touched networking for the route
  exposing the board UI.
