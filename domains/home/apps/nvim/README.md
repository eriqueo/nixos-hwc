...
- 2026-06-11: Delete the stale `parts/lua/.luarc.json` stub previously deployed into `~/.config` (a565f3de — audit §7.9 structural cleanups). The only output-affecting bit of that no-behavior-change pass.
