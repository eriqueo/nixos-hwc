...
#custom-dictation.recording { color: #${colors.error}; }
#custom-dictation.transcribing, #custom-dictation.delivering { color: #${colors.warning}; }
#custom-dictation.clipboard_ready, #custom-dictation.paste_dispatched { color: #${colors.success}; }
#custom-dictation.failed { color: #${colors.error}; }
