...
- **2026-06-15**: Wired into the new `domains/home/keymap` grammar factory —
  `index.nix` sources khalt's list-app bare verbs from the generated
  `to-khalt.nix` output, guarded to a no-op when the grammar is absent.
