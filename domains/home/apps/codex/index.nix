...
let
  ...
  agentsRender = pkgs.writeShellApplication {
    ...
    text = ''
      ...
      MARK='<!-- GENERATED by codex-agents-render from ~/.claude-config — edit codex/AGENTS.preamble.md, CLAUDE.md or engineering-principles.md, never this file -->'
      for src in codex/AGENTS.preamble.md CLAUDE.md engineering-principles.md; do
...
in
{
  ...
  options.hwc.home.apps.codex = {
    ...
    sharedConfigRepo = lib.mkOption {
      ...
      description = "Working tree of the shared claude-config repo: source of Codex skills, hooks.json and AGENTS.md inputs.";
    };
    ...
    shareHarness = lib.mkOption {
      type = lib.types.bool;
      default = config.hwc.home.apps.claude-code.shareConfig.enable;
  ...
  config = lib.mkIf cfg.enable (lib.mkMerge [
    ...
    (lib.mkIf cfg.shareHarness {
      ...
      hwc.home.apps.claude-code.shareConfig.sync.postMerge = [
        "${agentsRender}/bin/codex-agents-render"
        "${hooksTrust}/bin/codex-hooks-trust"
      ];
    })
