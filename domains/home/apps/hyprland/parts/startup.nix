# domains/home/apps/hyprland/parts/startup.nix
#
# HYPRLAND STARTUP SCRIPT - Pure derivation for session initialization
# Launches default applications on designated workspaces after Hyprland starts.
#
# USED BY (Downstream):
#   - domains/home/apps/hyprland/sys.nix (system package)

{ pkgs, ... }:

pkgs.writeScriptBin "hyprland-startup" ''
  #!/usr/bin/env bash
  set -euo pipefail
