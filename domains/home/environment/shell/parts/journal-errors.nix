# HWC Charter Module/domains/home/environment/shell/parts/journal-errors.nix
#
# JOURNAL-ERRORS PART - Journalctl error summarizer as proper derivation
# Pure function returning writeShellApplication for journal-errors command
#
# DEPENDENCIES: None (pure function)
# USED BY: domains/home/environment/shell/index.nix
#
# PURPOSE: Returns journal-errors script derivation for error log analysis
