...
- 2026-06-16: `5289d7b3` — removes the `600_shared` NFS share path
  (standardize on Syncthing). The corresponding `hwc.paths.shared` entry
  was retired from this module.
