...
- 2026-06-29: Remove `600_shared` NFS share (5289d7b3) — the lone NFS-mounted folder paralleling the Syncthing-replicated home folders is gone; cross-machine sharing standardizes on Syncthing. `hwc.paths.shared` (if any) callers should follow the new convention.
