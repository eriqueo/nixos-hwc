...
- 2026-06-13: Drop the `hwc.paths.sharedRoot` entry (and any `600_shared` references) — the lone NFS-mounted shared folder was empty and is gone; all cross-machine sharing standardizes on Syncthing (5289d7b3).
