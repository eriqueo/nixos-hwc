...
- 2026-06-29: Remove `600_shared` NFS share (5289d7b3) — n8n shared lane now lives on Syncthing. Convert option-declaring leaf modules to directory modules for Law 9/10 compliance (aea7be73). Law 3 path sweep derives the worst hardcoded paths from `hwc.paths` (61f22fa3).
