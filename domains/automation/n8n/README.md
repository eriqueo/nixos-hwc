...
- 2026-08-10: Law 12 refresh of the `parts/` READMEs — `migrations` (003 add +
  removal, duplicate `002-` prefix), `workflows` (dead sections dropped, `09`/`10`
  headings un-swapped, `12-voice-log.json` documented), `estimator-integration`
  (tailnet rename). Docs only; no workflow JSON or SQL changed.
