...
- 2026-08-03: Law 12 sweep of `parts/` READMEs — `workflows/README.md` marked
  `03-system-monitoring-alertmanager-router` and `05-cross-service-health-monitor`
  retired (deleted 2026-07-09) and logged the frigate HLS change;
  `migrations/README.md` picked up `002-calculator-leads.sql` and the deletion of
  `003-notification-events.sql`; `estimator-integration/README.md` gained
  Structure + Changelog. Docs only.
