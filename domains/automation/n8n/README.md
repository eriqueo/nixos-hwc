...
- 2026-08-31: Law 12 sweep — `parts/workflows/`,
  `parts/estimator-integration/` and `parts/migrations/` READMEs brought
  current with their contents (`17c9d203`). Documentation only; no workflow,
  SQL or Nix change.
