...
- 2026-03-31: Added the work_calculator_lead n8n workflow / Heartwood MCP `/call` endpoint migration (002-calculator-leads.sql) — JT + Postgres + Slack flow for bathroom-calculator leads.
