...
## Changelog
- 2026-06-22: Add changelog section for Charter Law 12 compliance; covers hwc-server tailnet rename (hwc.ocelot-wahoo.ts.net → hwc-server.ocelot-wahoo.ts.net).
