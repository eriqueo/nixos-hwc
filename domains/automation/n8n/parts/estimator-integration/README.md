...
## Changelog
- 2026-06-16: Mechanical sweep — `22bbbb48` renames the server tailnet host
  `hwc.ocelot-wahoo.ts.net` → `hwc-server.ocelot-wahoo.ts.net`. No
  integration-specific behavior change.
