...
**Actions**:
- Removed `graphical-session-pre.target` from `domains/mail/bridge/parts/service.nix`
...
**Actions**:
- Modified `domains/mail/bridge/options.nix`
...
**Actions**:
- Updated `domains/mail/accounts/index.nix`
...
**Actions**:
- Modified `domains/mail/bridge/parts/runtime.nix`
...
### Files Modified
- `domains/mail/bridge/parts/runtime.nix` - Added D-Bus env
- `domains/mail/accounts/index.nix` - Fixed login usernames
