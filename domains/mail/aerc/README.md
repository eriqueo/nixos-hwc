...
- 2026-06-22: Allow ssh and python3 commands in Claude Code session; theme/unify aerc commits — semantic ANSI families, blues unified to 5e81ac; morning briefing + home-manager standalone refactors touched aerc in sweep.
