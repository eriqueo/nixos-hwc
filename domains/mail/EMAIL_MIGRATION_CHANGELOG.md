...
**Files Modified:**
- `domains/mail/bridge/parts/runtime.nix` - Removed DBUS_SESSION_BUS_ADDRESS
- `domains/mail/bridge/parts/files.nix` - Added keychain.json generation
...
- ✅ **Phase 2.2**: Rewrote mbsync configuration
  - Updated `/home/eric/.nixos/domains/mail/accounts/index.nix`
