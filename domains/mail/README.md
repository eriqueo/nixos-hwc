...
## Changelog
- 2026-06-15: Sub-domain README backfill — `aerc/` refreshed for the long-uncaptured 2026-03-27..2026-05-21 iterations (Nord blue unification, ANSI semantic mapping, kitty/aerc styling, HM standalone, morning-briefing wiring, Claude Code session allowlist). No code change in the `domains/mail/` aggregator.
