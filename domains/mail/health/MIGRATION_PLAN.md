...
Move the mail infrastructure from `domains/mail/` (laptop-centric, Home Manager) to `domains/mail/` (server-primary, still Home Manager but top-level domain).
...
```
domains/mail/           # Home Manager modules under hwc.mail.*
