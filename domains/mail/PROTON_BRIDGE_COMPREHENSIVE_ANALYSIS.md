...
**Files involved**:
- `/home/eric/.nixos/domains/mail/bridge/` (Home Manager user service)
...
- Enable: `hwc.mail.bridge.enable = true`
...
- `/home/eric/.nixos/domains/mail/bridge/options.nix` - Update keychain config
...
2. **Enable user service**: `hwc.mail.bridge.enable = true;`
