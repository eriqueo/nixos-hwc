...
- **2026-06-09** — Charter Law 3 path sweep — drop remaining derivable hardcoded paths in the briefing module; derive output/runtime dirs from `hwc.paths.*` (6001f937). Pure refactor.
