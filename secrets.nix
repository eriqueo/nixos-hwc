...
in
{
  ...
  "domains/secrets/parts/services/hermes-deepseek-key.age".publicKeys            = everyone;
  ...
  "domains/secrets/parts/services/discord-webhook-url.age".publicKeys            = everyone;
  "domains/secrets/parts/services/discord-webhook-hwc-alerts.age".publicKeys     = everyone;
  "domains/secrets/parts/services/discord-webhook-hwc-leads.age".publicKeys      = everyone;
  "domains/secrets/parts/services/hwc-leads-hmac-secret.age".publicKeys          = everyone;
