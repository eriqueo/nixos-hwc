# nixos-hwc/modules/home/hyprland/parts/keybindings.nix
#
# Hyprland Keybindings: All 139 Preserved Exactly
# Charter v4 compliant - Pure data for user-tweakable keybindings
#
# DEPENDENCIES (Upstream):
#   - modules/infrastructure/hyprland-tools.nix (tool binaries)
#
# USED BY (Downstream):
#   - modules/home/hyprland/default.nix
#
# USAGE:
#   let kb = import ./parts/keybindings.nix { inherit lib pkgs; };
#   in { bind = kb.bind; bindm = kb.bindm or []; }
#
