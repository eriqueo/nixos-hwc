"""FastAPI application for transcript extraction API"""
...
async def lifespan(app: FastAPI):
    ...
    This avoids N workers per uvicorn worker problem.
    """
    # Configure structured logging
    configure_logging("yt-transcripts-api", level=config.log_level)
...
app = FastAPI(
    ...
    description="Extract transcripts from YouTube videos, playlists, and channels",
    version="0.1.0",
    lifespan=lifespan,
)
