...
print_info "Orchestrator Script: workspace/automation/media-orchestrator.py"
print_info "qBittorrent Hook: workspace/automation/qbt-finished.sh"
print_info "SABnzbd Hook: workspace/automation/sab-finished.py"
