...
| **System**         | Core OS + accounts + OS services | `domains/system/`         | users, sudo, networking, security, paths, system packages          | HM configs, secrets                          |
| **Secrets**        | Encrypted secrets management     | `domains/secrets/`        | age-encrypted files, secret definitions, key management            | Plaintext secrets, HM configs                |
