    ...
    describe('getSettingsSchema', () => {
        ...
        it('should have correct nested setting structure', () => {
            ...
            nestedSettings.forEach((setting) => {
                const definition = getSettingsSchema()[setting];
        ...
        it('should have accessibility nested properties', () => {
            ...
            expect(getSettingsSchema().ui?.properties?.accessibility.properties
                ?.disableLoadingPhrases.type).toBe('boolean');
        });
        it('should have checkpointing nested properties', () => {
            expect(getSettingsSchema().general?.properties?.checkpointing.properties
                ?.enabled).toBeDefined();
            expect(getSettingsSchema().general?.properties?.checkpointing.properties
                ?.enabled.type).toBe('boolean');
        });
        it('should have fileFiltering nested properties', () => {
            expect(getSettingsSchema().context.properties.fileFiltering.properties
        ...
        it('should have consistent default values for boolean settings', () => {
            ...
            checkBooleanDefaults(getSettingsSchema());
        });
        it('should have showInDialog property configured', () => {
            // Check that user-facing settings are marked for dialog display
            expect(getSettingsSchema().ui.properties.showMemoryUsage.showInDialog).toBe(true);
            expect(getSettingsSchema().ui.properties.footer.properties
                .hideContextPercentage.showInDialog).toBe(true);
            ...
            expect(getSettingsSchema().general.properties.disableAutoUpdate.showInDialog).toBe(true);
            ...
            expect(getSettingsSchema().privacy.properties.usageStatisticsEnabled
                .showInDialog).toBe(false);
            ...
            expect(getSettingsSchema().advanced.properties.autoConfigureMemory
                .showInDialog).toBe(false);
        });
        ...
        it('should have loadMemoryFromIncludeDirectories setting in schema', () => {
            expect(getSettingsSchema().context?.properties
                .loadMemoryFromIncludeDirectories).toBeDefined();
            expect(getSettingsSchema().context?.properties.loadMemoryFromIncludeDirectories
                .type).toBe('boolean');
            expect(getSettingsSchema().context?.properties.loadMemoryFromIncludeDirectories
        ...
        it('should have folderTrustFeature setting in schema', () => {
            ...
            expect(getSettingsSchema().security.properties.folderTrust.properties.enabled
                .type).toBe('boolean');
            expect(getSettingsSchema().security.properties.folderTrust.properties.enabled
        ...
        it('should have debugKeystrokeLogging setting in schema', () => {
            ...
            expect(getSettingsSchema().general.properties.debugKeystrokeLogging
                .requiresRestart).toBe(false);
            expect(getSettingsSchema().general.properties.debugKeystrokeLogging
                .showInDialog).toBe(true);
            expect(getSettingsSchema().general.properties.debugKeystrokeLogging
                .description).toBe('Enable debug logging of keystrokes to the console.');
        });
        it('should have previewFeatures setting in schema', () => {
            expect(getSettingsSchema().general.properties.previewFeatures).toBeDefined();
            expect(getSettingsSchema().general.properties.previewFeatures.type).toBe('boolean');
            expect(getSettingsSchema().general.properties.previewFeatures.category).toBe('General');
            expect(getSettingsSchema().general.properties.previewFeatures.default).toBe(false);
            expect(getSettingsSchema().general.properties.previewFeatures.requiresRestart).toBe(false);
            expect(getSettingsSchema().general.properties.previewFeatures.showInDialog).toBe(true);
            expect(getSettingsSchema().general.properties.previewFeatures.description).toBe('Enable preview features (e.g., preview models).');
        });
        it('should have useModelRouter setting in schema', () => {
            expect(getSettingsSchema().experimental.properties.useModelRouter).toBeDefined();
            expect(getSettingsSchema().experimental.properties.useModelRouter.type).toBe('boolean');
            expect(getSettingsSchema().experimental.properties.useModelRouter.category).toBe('Experimental');
            expect(getSettingsSchema().experimental.properties.useModelRouter.default).toBe(true);
        });
    });
