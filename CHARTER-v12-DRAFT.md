# HWC Architecture Charter v12.0 (DRAFT)
...
**Status**: DRAFT — promote by replacing `CHARTER.md` after review.
...
Separate `options.nix` files are forbidden — the v11.0 migration eliminated the pattern; the 16 stragglers found in the 2026-06-09 audit are tracked violations to burn down, not precedent.
